...
const Win = ({handleReturnHome, aiData}) => {
  return (
    <div className="min-h-screen w-full font-mono bg-[#050505] text-neutral-300 flex flex-col items-center justify-center p-6 selection:bg-[#22c55e]/30 relative overflow-hidden">
